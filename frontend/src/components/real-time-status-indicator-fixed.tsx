...
import { CustomAlert, CustomAlertTitle, CustomAlertDescription } from '@/components/custom-alert'
  ...
  return (
    <>
      ...
      {alertVisible && showAlert && connectionState === 'connected' && (
        <CustomAlert variant="success" className="mt-2">
          <CheckCircle className="h-4 w-4" />
          <CustomAlertTitle>Connection restored</CustomAlertTitle>
      ...
      {alertVisible && showAlert && connectionState === 'disconnected' && (
        <CustomAlert variant="destructive" className="mt-2">
          ...
          <CustomAlertTitle>Connection lost</CustomAlertTitle>
          <CustomAlertDescription>
