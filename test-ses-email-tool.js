...
async function runTest() {
  ...
  console.log('Using the AWS SES implementation from aws-ses-email.js');
  
  try {
    // Send a test email
    const result = await sendSESEmail({
      to_email: 'craig@elevenlabs.io', // Replace with your own email if needed
      subject: 'Test Email from ElevenLabs AI Agent',
      content: `
        <h1>This is a test email from the ElevenLabs AI Agent</h1>
